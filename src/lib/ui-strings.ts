...
export const uiStrings = {
  en: {
    ...
    mobileHint: 'This number must be the buyer’s own and registered with their wallet.',
  ...
  fa: {
    ...
    email: 'رایانامه',
    hours: 'ساعات کاری',
    instalments: 'پرداخت اقساطی',
    mobileHint: 'این شماره باید به نام خودِ خریدار و در کیف پول او ثبت شده باشد.',
