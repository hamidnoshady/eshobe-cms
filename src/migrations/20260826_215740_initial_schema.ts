...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_pricing_plans_link_type" AS ENUM('reference', 'custom');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_pricing_plans_link_type" AS ENUM('reference', 'custom');
  ...
  CREATE TYPE "public"."enum_users_tenants_role" AS ENUM('owner', 'editor');
  CREATE TYPE "public"."enum_users_role" AS ENUM('platformAdmin', 'user');
  CREATE TYPE "public"."enum_sites_available_locales" AS ENUM('fa', 'en');
  CREATE TYPE "public"."enum_sites_type" AS ENUM('business', 'portfolio', 'store');
  CREATE TYPE "public"."enum_sites_status" AS ENUM('active', 'suspended', 'archived');
  CREATE TYPE "public"."enum_sites_default_locale" AS ENUM('fa', 'en');
  CREATE TYPE "public"."enum_theme_radius" AS ENUM('none', 'sm', 'md', 'lg');
  ...
  CREATE TABLE "pages_blocks_team_members_locales" (
  	"name" varchar,
  	"role" varchar,
  	"bio" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "pages_blocks_pricing_plans" (
  	...
  	"price" numeric,
  	"enable_link" boolean,
  	"link_type" "enum_pages_blocks_pricing_plans_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean
  );
  
  CREATE TABLE "pages_blocks_pricing_plans_locales" (
  	"name" varchar,
  	"unit" varchar DEFAULT 'تومان',
  	"period" varchar,
  	"link_url" varchar,
  	"link_label" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_team_members_locales" (
  	"name" varchar,
  	"role" varchar,
  	"bio" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_pricing_plans" (
  	...
  	"price" numeric,
  	"enable_link" boolean,
  	"link_type" "enum__pages_v_blocks_pricing_plans_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"_uuid" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_logos_locales" (
  	"heading" varchar,
  	"intro" varchar,
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  ...
  CREATE TABLE "users_tenants" (
  	...
  	"role" "enum_users_tenants_role" DEFAULT 'editor' NOT NULL
  );
  ...
  CREATE TABLE "sites_available_locales" (
  	"order" integer NOT NULL,
  	"parent_id" uuid NOT NULL,
  	"value" "enum_sites_available_locales",
  	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL
  );
  ...
  CREATE TABLE "sites" (
  	...
  	"type" "enum_sites_type" DEFAULT 'business' NOT NULL,
  	"status" "enum_sites_status" DEFAULT 'active' NOT NULL,
  	"default_locale" "enum_sites_default_locale" DEFAULT 'fa' NOT NULL,
  	"generate_slug" boolean DEFAULT true,
  	"slug" varchar NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  ...
  CREATE TABLE "theme" (
  	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
  	"site_id" uuid,
  	"primary" varchar DEFAULT '#0f766e',
  	"accent" varchar DEFAULT '#f59e0b',
  	"background" varchar DEFAULT '#ffffff',
  	"foreground" varchar DEFAULT '#0a0a0a',
  	"radius" "enum_theme_radius" DEFAULT 'md',
  ...
  ALTER TABLE "_pages_v_blocks_logos_locales" ADD CONSTRAINT "_pages_v_blocks_logos_locales_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_logos"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "users_tenants" ADD CONSTRAINT "users_tenants_tenant_id_sites_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "users_tenants" ADD CONSTRAINT "users_tenants_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "users_sessions" ADD CONSTRAINT "users_sessions_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "sites_available_locales" ADD CONSTRAINT "sites_available_locales_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."sites"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "theme" ADD CONSTRAINT "theme_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "header" ADD CONSTRAINT "header_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "footer" ADD CONSTRAINT "footer_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "search" ADD CONSTRAINT "search_site_id_sites_id_fk" FOREIGN KEY ("site_id") REFERENCES "public"."sites"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE UNIQUE INDEX "pages_blocks_team_members_locales_locale_parent_id_unique" ON "pages_blocks_team_members_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE UNIQUE INDEX "_pages_v_blocks_team_members_locales_locale_parent_id_unique" ON "_pages_v_blocks_team_members_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE UNIQUE INDEX "_pages_v_blocks_logos_locales_locale_parent_id_unique" ON "_pages_v_blocks_logos_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE INDEX "sites_available_locales_order_idx" ON "sites_available_locales" USING btree ("order");
  CREATE INDEX "sites_available_locales_parent_idx" ON "sites_available_locales" USING btree ("parent_id");
  ...
  CREATE UNIQUE INDEX "theme_site_idx" ON "theme" USING btree ("site_id");
  ...
  CREATE UNIQUE INDEX "header_site_idx" ON "header" USING btree ("site_id");
  ...
  CREATE UNIQUE INDEX "footer_site_idx" ON "footer" USING btree ("site_id");
  ...
  CREATE INDEX "search_site_idx" ON "search" USING btree ("site_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "_pages_v_blocks_logos_locales" CASCADE;
  ...
  DROP TABLE "sites_available_locales" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_blocks_pricing_plans_link_type";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_pricing_plans_link_type";
  ...
  DROP TYPE "public"."enum_sites_available_locales";
