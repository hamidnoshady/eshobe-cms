...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
    ...
    ALTER TABLE "theme_packages" ADD COLUMN IF NOT EXISTS "runtime_settings_schema" jsonb;
    ALTER TABLE "theme_packages" ADD COLUMN IF NOT EXISTS "content_slots_schema" jsonb;
    ...
    ALTER TABLE "site_branding" ADD CONSTRAINT "site_branding_primary_logo_id_media_id_fk" FOREIGN KEY ("primary_logo_id") REFERENCES "media"("id") ON DELETE set null;
    ALTER TABLE "site_branding" ADD CONSTRAINT "site_branding_compact_logo_id_media_id_fk" FOREIGN KEY ("compact_logo_id") REFERENCES "media"("id") ON DELETE set null;
    ALTER TABLE "site_branding" ADD CONSTRAINT "site_branding_light_logo_id_media_id_fk" FOREIGN KEY ("light_logo_id") REFERENCES "media"("id") ON DELETE set null;
    ALTER TABLE "site_branding" ADD CONSTRAINT "site_branding_dark_logo_id_media_id_fk" FOREIGN KEY ("dark_logo_id") REFERENCES "media"("id") ON DELETE set null;
    ALTER TABLE "site_branding" ADD CONSTRAINT "site_branding_favicon_id_media_id_fk" FOREIGN KEY ("favicon_id") REFERENCES "media"("id") ON DELETE set null;
    ALTER TABLE "site_branding" ADD CONSTRAINT "site_branding_social_image_id_media_id_fk" FOREIGN KEY ("social_image_id") REFERENCES "media"("id") ON DELETE set null;
    ...
    ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_site_branding_fk" FOREIGN KEY ("site_branding_id") REFERENCES "site_branding"("id") ON DELETE cascade;
    CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_site_branding_id_idx" ON "payload_locked_documents_rels"("site_branding_id");
...
export async function down({ db }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
    ...
    ALTER TABLE "theme_packages" DROP COLUMN IF EXISTS "runtime_settings_schema";
    ALTER TABLE "theme_packages" DROP COLUMN IF EXISTS "content_slots_schema";
