 ...
 */
export const toLocaleDigits = (value, locale) => locale === 'fa' ? toAsciiDigits(value).replace(/[0-9]/g, (d) => PERSIAN_DIGITS[Number(d)]) : value;
/**
 * Persian-Indic and Arabic-Indic digits → ASCII, for anything typed *into* the
 * platform.
 */
export const toAsciiDigits = (value) => value
